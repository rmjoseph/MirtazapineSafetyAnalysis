...
* Creator:	RMJ
* Date:	20201006
* Desc:	Testing the proportional hazards assumption for self harm outcome
* Version History:
...
egen newend = rowmin(enddate6 serioussh_int)
...
**** SUMMARY
** By all checks, the PH assumption looks fine
