...
*************************************
* Name:	sh30_DoseAdjustedAdjRegression_SelfHarm
* Creator:	RMJ
* Date:	20210312
* Desc:	Adjusted regression, self harm, adjusting for dose
* Version History:
*	Date	Reference	Update
*	20210312	DoseAdjustedAdjRegression_SelfHarm	Create file
*************************************

*** Log
capture log close doseadj430
local date: display %dCYND date("`c(current_date)'", "DMY")
log using "logs/sh30_doseadjusted_adjreg_outcome3_`date'.txt", text append name(doseadj430)
*******
...
frget index newstop enddate30 serioussh_int outcome, from(default)
...
// Save
export delim using outputs/sh30_doseadj_adj_selffharm.csv, replace

log close doseadj430
exit
