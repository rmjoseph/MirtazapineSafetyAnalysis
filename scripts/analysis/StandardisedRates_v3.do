...
*	20210415	StandardisedRates_v2	Invert mvs mva mvv so the attributable risks calculate comparator - mirtazapine
*************************************
...
forval OUT=1/5 {
	...
	*** Export as table
	...
	export delim using "outputs/standardised_v3_`name'.csv", replace
