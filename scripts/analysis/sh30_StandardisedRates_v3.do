...
*************************************
* Name:	sh30_StandardisedRates_v3
* Creator:	RMJ
* Date:	20210506
* Desc:	Same as earlier version but a.using enddate30 and b.only using selfharm outcome
* Version History:
*	Date	Reference	Update
*	20210312	StandardisedRates_v2	Create file
*	20210325	sh30_StandardisedRates_v2	Exclude people with stop==start
*	20210506	sh30_StandardisedRates_v2	Invert mvs mva mvv so the attributable risks calculate comparator - mirtazapine
************************************
...
*** Export as table
export delim using "outputs/sh30_standardised_selfharm.csv", replace
