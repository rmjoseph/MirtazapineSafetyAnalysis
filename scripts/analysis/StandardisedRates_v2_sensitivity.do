* Created 2020-10-14 by Rebecca Joseph at the University of Nottingham
*************************************
* Name:	StandardisedRates_v2_sensitivity
* Creator:	RMJ
* Date:	20201014
* Desc:	Runs the standardised rates file on sensitivity analyses
* Version History:
*	Date	Reference	Update
*	20200506	StandardisedRates	Created file
*************************************
	...
	** Open loop
	forval OUT=1/5 {
		...
		*** Export as table
		...
		export delim using "outputs/standardised_`name'_`tag'.csv", replace
