...
*************************************
* Name:	DoseAdjustedIPTWRegression_SelfHarm
* Creator:	RMJ
* Date:	20210224
* Desc:	IPTW regression for self harm, adjusted for dose
* Version History:
*	Date	Reference	Update
*	20210224	DoseAdjustedIPTWRegression_AllCause	Create file
*************************************

*** Log
capture log close doseadj3
local date: display %dCYND date("`c(current_date)'", "DMY")
log using "logs/doseadjusted_iptw_outcome3_`date'.txt", text append name(doseadj3)
*******
...
frget indexdate newstop enddate6 serioussh_int outcome, from(default)
drop default
...
use data/clean/imputed_outcome3, clear
...
** Output
export delim using outputs/doseadj_iptw_selfharm.csv, replace
