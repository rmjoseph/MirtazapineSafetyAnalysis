* Created 2021-04-15 by Rebecca Joseph at the University of Nottingham
*************************************
* Name:	StandardisedRates_v3_sensitivity
* Creator:	RMJ
* Date:	20210415
* Desc:	Runs the standardised rates file on sensitivity analyses
* Version History:
*	Date	Reference	Update
*	20210415	StandardisedRates_v2_sensitivity	Change mvs mva mvv def to invert attrib risks
*************************************
...
forval Z = 1/3 {
	...
	** START: load dataset (restriction will depend on the analysis)
	...
	keep cohort patid keep1 eligible bipolar schizophrenia inc_switch90 depress_12 ageindex sex endreason6 index cod_L1 serioussh_int enddate6 palliative selfharm bl_intselfharm 
	...
	** Open loop
	forval OUT=1/5 {
		...
		*** Export as table
		...
		export delim using "outputs/standardised_v3_`name'_`tag'.csv", replace
